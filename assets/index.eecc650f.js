...
`,be=H.addFolder("player"),ge=Q.map((({a:e,d:r,w:o,s:t})=>[r?1:e?-1:0,o?1:0])),we=O.scan(((e,r)=>{const[o]=ge();return e-o*be.auto(1.5,"rotate",.1,2)()*Math.PI*r}),0,O.combine((e=>0!==ge()[0]?e():void 0),[J])),he=[0,-1],xe=we.map(C(le,(e=>se(he,e)))),$e=J.map((e=>xe().map((r=>r*(ge()[1]*be.auto(.05,"acceleration",.025,.1)()*e))))),Ae=be.auto(.02,"maxSpeed",.005,.05).map((e=>r=>ce(r)>e?ne(ae(r),e):r)),Ie=O.scan(C(te,(e=>Ae()(e))),[0,0],$e),Se=z`
